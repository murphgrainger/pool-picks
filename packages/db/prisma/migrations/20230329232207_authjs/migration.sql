...
*/
-- DropForeignKey
ALTER TABLE "PoolMember" DROP CONSTRAINT "PoolMember_user_id_fkey";
...
-- AlterTable
ALTER TABLE "AthletesInTournaments" ADD COLUMN     "score_under_par" INTEGER;

-- AlterTable
ALTER TABLE "PoolMember" ALTER COLUMN "user_id" SET DATA TYPE TEXT;

-- AlterTable
ALTER TABLE "Tournament" ADD COLUMN     "external_id" INTEGER;
